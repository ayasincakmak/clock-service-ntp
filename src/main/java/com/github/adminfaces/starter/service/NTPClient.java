...
public  class NTPClient
{
    ...
    public static String processResponse(TimeInfo info)
    {
        ...
        str.append(" Reference Identifier:\t" + refAddr);
        TimeStamp refNtpTime = message.getReferenceTimeStamp();
        System.out.println(" Reference Timestamp:\t" + refNtpTime + "  " + refNtpTime.toDateString());
        str.append(" Reference Timestamp:\t" + refNtpTime + "  " + refNtpTime.toDateString());
        ...
        str.append(" Receive Timestamp:\t" + rcvNtpTime + "  " + rcvNtpTime.toDateString());
        // Transmit time is time reply sent by server (t3)
        TimeStamp xmitNtpTime = message.getTransmitTimeStamp();
        System.out.println(" Transmit Timestamp:\t" + xmitNtpTime + "  " + xmitNtpTime.toDateString());
        str.append(" Transmit Timestamp:\t" + xmitNtpTime + "  " + xmitNtpTime.toDateString());
        // Destination time is time reply received by client (t4)
        TimeStamp destNtpTime = TimeStamp.getNtpTime(destTime);
        System.out.println(" Destination Timestamp:\t" + destNtpTime + "  " + destNtpTime.toDateString());
        str.append(" Destination Timestamp:\t" + destNtpTime + "  " + destNtpTime.toDateString());
    ...
    public  String getNtpInfo(String host)
     {
